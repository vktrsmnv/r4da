...
usethis::use_git_config(user.name = "Viktoriia Semenova", user.email = "semenova@uni-mannheim.de")
```
...
If everything works well–congrats, you are all set for the semester! If something doesn't work---don't worry, just talk to me before or after class and we'll figure it out together on Tuesday. 
