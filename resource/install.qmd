...
3.  Click on *Download R-4.3.1 for Windows*.
...
1.  Go to <https://git-scm.com/downloads> and click on your operating
    system.
2.  Download the latest release (at the time of writing, it is 2.42.0).
...
to select the validity period of your PAT - Expiration (please keep the default 30 days for now), and click on **Generate Token** at the bottom of the page.
