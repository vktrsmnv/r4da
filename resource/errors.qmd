...
hesitate to contact us using GitHub Discussions. Each error and warning
is a good possibility to learn something about using R properly, so it
is not a time loss when you search for solutions.
