...
<!-- Here's your schedule for the semester! -->

<!-- - [**Prepare**](/prepare/) ({{< fa book-open-reader >}}): This page contains readings and videos for the week. Read and watch these **before** our in-person class.  -->

<!-- - [**Sessions**](/session/) ({{< fa laptop-code >}}): Here you can find the slides and further material from our in-person sessions.  -->

<!-- - [**Assignments**](/assignment/) ({{< fa code >}}): This page contains the instructions for weekly problem sets.  -->
...
show_table <- function(group_id) {
  ...
  tbl <- schedule_nested$data[[group_id]] %>% 
    ...
    kbl(escape = FALSE, align = "rrlcccc", table.attr = 'class="schedule-table"') %>% 
