...
![Poltical Campaigning Graph](https://www.andrewheiss.com/research/chapters/heiss-causal-inference-2021/money-votes-complex.png){height="600"}
...
::: columns
::: {.column width="50%"}
![](images/repression_tab.png)
:::

::: {.column width="50%"}
![](images/repression_fig.png)
:::
:::
:::

## [Our Starting Point & Your Expectations](https://viktoriiasemenova.typeform.com/report/c6lhg7Od/r1K8zSzrzuvRdXYX) {.smaller}
...
> Choosing the right method of analysis (for the Research question) <br> To find the right (control) variables <br> Being aware of the results and limitations <br> Translating concepts into variables for OLS <br> The interpretation of an own analysis 
:::
...
<!-- -   `r icons::fontawesome("robot")` Generative AI policy {height="600"} --> 
...
![](images/slack-formatting.png){height="200"}
