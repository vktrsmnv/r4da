...
un_votes <- readr::read_csv("https://r4da.netlify.app/files/data/external_data/un_votes.csv")
...
![](images/styler.png){width="80%"} - More on styling [on course website](https://r4da.netlify.app/resource/style.html)
