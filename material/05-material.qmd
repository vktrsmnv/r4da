---
title: "Data Merging and Reshaping"
date: "2023-10-04"
draft: false
editor_options: 
...
- Merging datasets using `dplyr` functions
- Generating identifier variables in country data using `countrycode` package 
- Transforming datasets from long to wide formats and vice versa 
- Generate line plots in `ggplot2`
