...
-   Describe bivariate relationships, numerically and graphically
-   Create descriptive statistics tables for datasets
-   Understand the differences between common measures of association 
...
[<button class="btn"><i class="fa fa-download"></i> PDF Version</button>](../slides/03-slides.pdf)

<iframe src="../slides/03-slides.html" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen width="800" height="450">
