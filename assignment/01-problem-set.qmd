...
If everything worked fine, you should now have a subfolder `01_problem_set_[username]` in the folder our selected when cloning the project. 
...
1. Click on `Git` in the environment pane on the upper right. If nothing appears in the *Git* pane in RStudio, click on the Refresh 
...
Open the file `problem_set.qmd`. This is the file that allows you to both write the code and the text, so you can produce well-formatted reports. Complete the tasks written there. You do not *have to* commit/push the work in progress, but you are more then welcome to! 
...
4. Write a _Commit Message_ in the upper right window. **For this task, please use _"Final version"_ as your commit message**. 
